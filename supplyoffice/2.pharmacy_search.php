...
$sql = "SELECT * FROM supply_requests WHERE types = 'pharmacy' AND (product_name LIKE ? OR unit_of_issue LIKE ? OR status LIKE ? OR DATE_FORMAT(request_date, '%Y-%m-%d') LIKE ?) ORDER BY request_date DESC";
...
if ($result->num_rows > 0) {
    ...
    ?>
    <tr>
        <td colspan="9">No results found</td> <!-- Updated colspan to match the number of columns -->
    </tr>
    <?php
}
?>
