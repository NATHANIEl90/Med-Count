...
$sql = "SELECT * FROM supply_requests WHERE types = 'laboratory' AND (product_name LIKE ? OR unit_of_issue LIKE ? OR status LIKE ? OR DATE_FORMAT(request_date, '%Y-%m-%d') LIKE ?) ORDER BY request_date DESC";
