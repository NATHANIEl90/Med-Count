            ...
            <div class="h-100">
                ...
                <div class="tabs-list">
                    <ul class="sidebar-nav nav-pills">
                        ...
                        <li class="sidebar-item test_3" data-tc="tab_9">
                        ...
                        <div class="card-body">
                            ...
                            <table id="supplyTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM supply_office ORDER BY product_name ASC";
                        ...
                        <div class="card-body">
                            ...
                            <table id="pharmacyTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM pharmacy ORDER BY product_name ASC";
                                    $result = mysqli_query($conn, $sql);
                        ...
                        <div class="card-body">
                            ...
                            <table id="laboratoryTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM laboratory ORDER BY product_name ASC";
                                    $result = mysqli_query($conn, $sql);
                        ...
                        <div class="card-body">
                            ...
                            <table id="laboratoryRequestTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM supply_requests WHERE types = 'laboratory' AND status = 'Approved' ORDER BY product_name ASC";
                                    $result = mysqli_query($conn, $sql);
                        ...
                        <div class="card-body">
                            ...
                            <table id="centralRequestTable" class="table table-hover text-center">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM supply_requests WHERE types = 'central_supply' AND status = 'Approved' ORDER BY product_name ASC";
                                    $result = mysqli_query($conn, $sql);
