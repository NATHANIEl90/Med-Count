...
$pharmacy_sql = "SELECT COUNT(*) as pharmacy_requests FROM supply_requests WHERE types = 'pharmacy' AND status = 'Approved'";
$laboratory_sql = "SELECT COUNT(*) as laboratory_requests FROM supply_requests WHERE types = 'laboratory' AND status = 'Approved'";
$central_sql = "SELECT COUNT(*) as central_requests FROM supply_requests WHERE types = 'central_supply' AND status = 'Approved'";
