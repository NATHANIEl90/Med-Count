...
$sql = "SELECT * FROM laboratory WHERE product_name LIKE ? OR product_num LIKE ? OR unit_of_issue LIKE ? OR batch_num LIKE ? OR `exp.date` LIKE ? OR unit_value LIKE ? OR onhand LIKE ? OR stock_bal LIKE ? ORDER BY product_name ASC";
