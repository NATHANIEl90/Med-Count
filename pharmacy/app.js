      ...
      if (query.length > 2) {
          $.ajax({
              ...
              success: function(data) {
                  ...
                  $('#product_suggestions').html(dropdown);
              }
          });
      }
  });

  // When a product is selected, autofill the unit of issue
  $('input[name="product_name[]"]').on('change', function() {
      let selectedProduct = $(this).val();
      let selectedOption = $('#product_suggestions option[value="' + selectedProduct + '"]');
